...
--
-- Definition of table `tb_enquete`
--
...
--
-- Definition of table `tb_enquete_opcao`
--
...
--
-- Definition of table `tb_enquete_votacao`
--
...
--
-- Definition of table `tb_galeria`
--
...
--
-- Definition of table `tb_imagem_galeria`
--
...
--
-- Definition of table `tb_post_galeria`
--
...
--
-- Definition of table `tb_publicidade`
--
...
--
-- Definition of table `tb_publicidade_numclique`
--
...
INSERT INTO `tb_usuario` (`usuario_id`,`usuario_nivel_id`,`usuario_nome`,`usuario_login`,`usuario_senha`,`usuario_email`,`usuario_avatar`) VALUES 
 (1,1,'Jonas Mendes','tchoi','destino','inboxfox@gmail.com',' ');
