...
class Securimage {
    ...
    */
     ...
     * @var string
     */
    var $session_name = 'GET_READY_GO_2011_SITE';
    ...
    function Securimage()
    {
        ...
        $this->gd_font_file  = 'gdfonts/anonymous.gdf';
        ...
        $this->text_color       = new Securimage_Color(0xCC, 0xCC, 0xCC);
        ...
        $this->num_lines            = 10;
        $this->line_color           = new Securimage_Color(0xee, 0xee, 0xee);
        ...
        $this->session_name = 'GET_READY_GO_2011_SITE';
